        ...
        <ul id="side-menu">
            ...
            <li class="@if(request()->segment(1)=='arrears'){{'menuitem-active'}}@endif">
                ...
                <div class="collapse @if(request()->segment(1)=='arrears'){{'show'}}@endif" id="arrears">
                    <ul class="nav-second-level">
                        <li  class="@if(request()->segment(2)=='processingarrears'|| request()->segment(2)=='viewarrears'){{'menuitem-active'}}@endif"> <a href="{{url('arrears/sectionarrears/'.Crypt::encryptString('ACTIVE'))}}">Section Arrears</a> </li>
                        <li  class="@if(request()->segment(2)=='membersarrears' || request()->segment(2)=='memberpenalty' || request()->segment(2)=='memberarrearsprocessing'|| request()->segment(2)=='memberarrearsview'){{'menuitem-active'}}@endif"> <a href="{{url('arrears/membersarrears/'.Crypt::encryptString('ACTIVE'))}}">Member Arrears</a> </li>
