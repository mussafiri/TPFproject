                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Adding New User</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                    ...
                    <div class="col-12">
                        <div class="card-box">
                                        ...
                                        <div class="col-12 px-2">
                                                <form method="POST" enctype="multipart/form-data" action="{{url('users/add/submit')}}">
                                                @csrf
                                                    <div class="col-12">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="row">  
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="fname" class="form-control form-control-sm" value="{{old('fname')}}" oninput="this.value = this.value.toUpperCase()" id="field-1" placeholder="First Name">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="mname" class="form-control form-control-sm" value="{{old('mname')}}" oninput="this.value = this.value.toUpperCase()" id="field-1" placeholder="Middle Name">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="lname" class="form-control form-control-sm" value="{{old('lname')}}" oninput="this.value = this.value.toUpperCase()" id="field-1" placeholder="Last Name">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="dateOfBirth" class="form-control form-control-sm" data-provide="datepicker" data-date-autoclose="true" data-date-format="dd M, yyyy"  value="{{old('dateOfBirth')}}" placeholder="Pick Date of Birth"  id="field-4" required>
