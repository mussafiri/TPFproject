                        ...
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <div class="auth-logo">
                                        <a href="{{ url('/member/login') }}" class="logo logo-dark text-center">
                                            <span class="logo-lg">
                                                <img src="https://www.tpf.or.tz/images/logo.jpg" alt="" height="70">
                                            </span>
                                        </a>
                    
                                        <a href="{{ url('/member/login') }}" class="logo logo-light text-center">
                                            <span class="logo-lg">
                                                <img src="https://www.tpf.or.tz/images/logo.jpg" alt="" height="70">
                                            </span>
                                        </a>
                                ...
                                <div class="mt-3 text-center">
                                    ...
                                    <p class="text-muted font-14 mt-2"> Your account has been suspended. Kindly, contact TPF Administrator for assistance</p>

                                    <a href="{{url('member/login')}}" class="btn btn-block btn-info waves-effect waves-light mt-3">Back to Login</a>
                                </div>
