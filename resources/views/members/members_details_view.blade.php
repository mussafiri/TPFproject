                                ...
                                <table class="table table-sm font-12 table-striped w-100 datatable-buttons table-responsible">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($dependants as $dep_data)
                                            @php
                                                $picture              = $dep_data->picture == "NULL" ? '': '<span data-toggle="tooltip" data-placement="top" title="Picture" data-original-title="Tooltip on top"><a href="'.Storage::url('members/dependants/photo/'.$dep_data->picture).'" class="text-info" target="_blank"><i class="font-14 mdi flaticon-image mr-1"></i></a></span>';                                        
                                                $marriagecertificate  = $dep_data->marriagecert == "NULL" ? '': '<span data-toggle="tooltip" data-placement="top" title="Marriage Certificate" data-original-title="Tooltip on top"><a href="'.Storage::url('members/dependants/certificates/'.$dep_data->marriagecert).'" class="text-info" target="_blank"><i class="mdi flaticon-wedding-contract mr-1"></i></a></span>';                                        
                                                $birthcertificate     = $dep_data->birthcert == "NULL" ? '': '<span data-toggle="tooltip" data-placement="top" title="Birth Certificate" data-original-title="Tooltip on top"><a href="'.Storage::url('members/dependants/certificates/'.$dep_data->birthcert).'" class="text-info" target="_blank"><i class="mdi flaticon-bill-2 mr-1"></i></a></span>'; 
