                                ...
                                <div class="mt-3 text-center">
                                    ...
                                    <h3>Success !</h3>
                                        ...
                                        @endif
                                            ...
                                            <!-- end row -->
                                             <button type="submit" class="btn btn-block btn-pink waves-effect waves-light mt-3">Resend Verification Email</button>
                                             <a href="{{route('login')}}" class="btn btn-block btn-pink waves-effect waves-light mt-3">Back to Login</a>
                                            </form>
                                </div>
